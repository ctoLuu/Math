...
class GA(object):
    ...
    def comp_fit(self, CN):
        ...
        res = res - 0.003 * 48 * max / 1.05 + charge * 0.8257
        return res
    ...
    def info(self, CN):
        ...
        charge_price = res + charge * 0.8257
        return demand_price, charge_price
...
if __name__ == "__main__":
    ...
    for i in range(module.maxgen):
        ...
        if (i + 1) % 10 == 0:
            ...
            demand_price, charge_price = module.info(module.chrom[index])
            print(demand_price)
            print(charge_price)
    ...
    best = module.chrom[0]
    print(best)
    demand_price, charge_price = module.info(best)
    print(demand_price)
    print(charge_price)